...
WHERE discount_applied = 'Yes' 
  ...
  -- Q3 - For every product, calculate its average review rating, rank the products from highest average rating to lowest, and show only the top 5. 
...
-- Q.4 - What is the average amount spent by customers using Standard shipping versus Express shipping?"
